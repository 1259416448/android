...
public class NewFootAdapter extends ArrayAdapter<CommentBean> {
    Context ctx;
    List<CommentBean> datas;
    LayoutInflater mInflater;
    int layout;

    public NewFootAdapter(Context ctx, List<CommentBean> datas) {
        super(ctx, R.layout.msg_new_foot_item);
        this.layout = R.layout.msg_new_foot_item;
        this.ctx = ctx;
        this.datas = datas;
