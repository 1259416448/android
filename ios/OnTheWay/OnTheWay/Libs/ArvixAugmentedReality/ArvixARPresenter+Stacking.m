...
@implementation ArvixARPresenter (Stacking)
...
- (void)stackAnnotationViews
{
    ...
    if (self.arViewController && self.arViewController.arStatus) {
        ...
        ArvixARStatus *arStatus = self.arViewController.arStatus;
        ...
        NSArray *sortedAnnotationViews = [tempArry sortedArrayUsingComparator:^(id obj1, id obj2){
            ...
            ArvixARAnnotationView *anno1 = obj1;
            ArvixARAnnotationView *anno2 = obj2;
        ...
        for (ArvixARAnnotationView *annotationView1 in sortedAnnotationViews) {
            //===== Alternate frame
            ...
            while (i < sortedAnnotationViews.count) {
                ArvixARAnnotationView *annotationView2 = sortedAnnotationViews[i];
