...
@protocol ArvixARTrackingManagerDelegate;

@interface ArvixARTrackingManager : NSObject
...
@property (nonatomic, weak) id<ArvixARTrackingManagerDelegate> delegate;
...
/**
 * default YES 当前值为 NO 时，在ArvixARViewController 执行  onViewDidDisappear -> stopCameraAndTracking 不会停止 Tracking ， startCameraAndTracking 时 ，也不会启动 Tracking
 */
@property (nonatomic, assign) BOOL stopLocation;
...
@protocol ArvixARTrackingManagerDelegate <NSObject>
