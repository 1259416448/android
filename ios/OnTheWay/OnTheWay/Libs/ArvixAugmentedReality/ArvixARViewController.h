...
@class UiOptions;
@class ArvixARPresenter;
@class ArvixARStatus;
@protocol ArvixARDataSource;

@interface ArvixARViewController : UIViewController

@property (nonatomic, strong) ArvixARRadar *radar; // 雷达

/**
 * Data source - source of annotation views for ARViewController/ARPresenter, implement it to provide annotation views.
 */
@property (nonatomic, weak) id<ArvixARDataSource> dataSource;
 ...
 */
@property (nonatomic, strong) ArvixARTrackingManager *trackingManager;
...
@property (nonatomic, strong) ArvixARPresenter *presenter;

@property (nonatomic, strong) ArvixARStatus *arStatus;

@property (nonatomic, copy) NSArray<ArvixARAnnotation*> *annotations;
@property (nonatomic, strong) ArvixCameraView *cameraView;
