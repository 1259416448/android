...
@interface ArvixARPresenter : UIView
...
@property (nonatomic, weak) ArvixARViewController *arViewController;
/**
 * All annotations
 */
 ...
 */
@property (nonatomic, copy) NSArray<ArvixARAnnotation*> *activeAnnotations;
/**
 * AnnotionViews for all active annotations, this is set in createAnnotationViews.
 */
@property (nonatomic, copy) NSArray<ArvixARAnnotationView*> *annotationViews;
/**
 * AnnotationViews that are on visible part of the screen or near its border.
 */
@property (nonatomic, copy) NSArray<ArvixARAnnotationView*> *visibleAnnotationViews;
