...
import cn.arvix.ontheway.footprint.service.CommentMessageService;
 ...
 */
@Controller
@RequestMapping(value = "/app/message/comment")
public class AppCommentMessageController extends ExceptionHandlerController {

    private CommentMessageService service;

    @Autowired
    public void setService(CommentMessageService service) {
    ...
    @ApiOperation(value = "获取评论消息 clear = true 清空消息页面中提醒数据")
