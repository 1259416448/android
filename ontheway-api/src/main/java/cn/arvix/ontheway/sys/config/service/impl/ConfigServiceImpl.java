...
public class ConfigServiceImpl extends BaseServiceImpl<Config, Long> implements ConfigService {
     ...
     */
    @Override
    public boolean checkMapName(String mapName, Long companyId) {
        return false;
    }
     ...
     */
    @Override
    public BigDecimal getConfigBigDecimal(String configName, Long companyId) {
        return null;
    }
     ...
     */
    @Override
    public boolean getConfigBoolean(String configName, Long companyId) {
        return false;
    }
     ...
     */
    @Override
    public String getConfigString(String configName, Long companyId) {
        return null;
    }
     ...
     */
    @Override
    public Date getConfigDate(String configName, Long companyId) {
        return null;
    }
     ...
     */
    @Override
    public Object getConfig(String configName, Long companyId) {
        return null;
    }
     ...
     * 获取所有配置信息
     *
     * @param companyId saas公司ID
     * @return config json
     */
    @Override
    public JSONResult search(Long companyId) {
        return null;
    }
}
