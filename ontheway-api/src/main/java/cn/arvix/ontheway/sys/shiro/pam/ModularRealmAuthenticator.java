package cn.arvix.ontheway.sys.shiro.pam;
...
public class ModularRealmAuthenticator extends AbstractAuthenticator {
    ...
    |             C O N S T A N T S             |
    ============================================*/
    private static final Logger log = LoggerFactory.getLogger(org.apache.shiro.authc.pam.ModularRealmAuthenticator.class);
