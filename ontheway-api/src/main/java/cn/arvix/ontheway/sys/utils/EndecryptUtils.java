...
public final class EndecryptUtils {
    ...
    public static boolean checkMd5Password(String username, String password, String salt, String md5cipherText) {
        ...
        //System.out.println("密文是1：" + password_cipherText);
        //System.out.println("密文是2：" + md5cipherText);
    ...
    public static void main(String[] args) {
        ...
        String salt = "cn/arvix";
        String cipherText_md5 = new Md5Hash(password, "YXJ2aXhtYXN0ZXI=" + salt, 2).toHex();
        ...
        String aes_cipherText = aesCipherService.encrypt(password.getBytes(), Base64.decode(keyStr)).toHex();
        System.out.println(password + " aes加密的密文是：" + aes_cipherText);
        System.out.println(encrytBase64(password));
        String aes_mingwen = new String(aesCipherService.decrypt(Hex.decode(aes_cipherText), Base64.decode(keyStr)).getBytes());
