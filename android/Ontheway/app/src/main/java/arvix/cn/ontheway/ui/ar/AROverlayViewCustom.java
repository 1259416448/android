...
public class AROverlayViewCustom   implements FootPrintSearchNotify<FootPrintBean>, View.OnTouchListener {
    ...
    private final float radius= StaticMethod.dip2px(App.self , 40f);
    ...
    public AROverlayViewCustom(Context context, ViewGroup rootView, FootPrintSearchVo trackSearchVo) {
                    ...
                    if (cameraCoordinateVector[2] < 0) {
                       ...
                       // Log.i(logTag, "drawRadar point radarX:" + radarX + ",radarY:" + radarY + "  radius:"+radius);
                        ...
                        if (convertViewTemp != null) {
                         ...
                         //   moveViewWithAnimation(convertViewTemp,convertViewTemp.getLeft()*1.0f,drawX,convertViewTemp.getTop()*1.0f,drawY,10,0,false);
